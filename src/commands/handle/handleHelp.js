...
module.exports = async (message,lang,prefix) => {
    ...
    newMessage.addField(`${prefix}handle info`,`\`\`\`css\n${lang.trad.dont_know_handle}\n\`\`\``,true);
    ...
    newMessage.addField(`${prefix}handle *\`${lang.trad.handle}\`*`,`\`\`\`css\n${lang.trad.display_handle_profile}\n\`\`\``,true);
